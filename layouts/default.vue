<template>
	<div class="wrapper min-h-screen flex flex-col">
		...
		<div class="flex grow">
			<div class="bg-slate-100 w-72 shrink-0 antialiased text-slate-800 selection:bg-blue-600 selection:text-white">
...
async function logout() {
	...
	// const { data, pending, error, refresh } = await useFetch("http://api.wesma.local/api/auth/logout", {
	// 	method: "POST",
	// 	headers: {
	...
	// 	clearInterval(store.intervalRefresh);
	// 	router.push({ path: "/auth" });
	// });
}
</script>
